...
export function ReviewPopup() {
  ...
  return (
    ...
    >
      ...
      <a href={SITE.googleReviewUrl} target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 pr-4">
        ...
        <div>
          <p className="line-clamp-2 text-sm text-charcoal">{review.review}</p>
          <p className="mt-1.5 text-xs text-gold-dark" aria-hidden="true">★★★★★</p>

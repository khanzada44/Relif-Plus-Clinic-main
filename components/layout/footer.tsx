...
const SOCIAL_PLATFORMS = [
  {
    key: "instagram",
    label: "Instagram",
    url: "https://www.instagram.com/relief.plus.wellness/?hl=en",
    Icon: InstagramIcon,
  },
  {
    key: "facebook",
    label: "Facebook",
    url: "https://www.facebook.com/p/Relief-Plus-Wellness-61577874874222/",
    Icon: FacebookIcon,
  },
  {
    key: "tiktok",
    label: "TikTok",
    url: "https://www.tiktok.com/@relief.plus.wellness",
    Icon: TikTokIcon,
  },
            ...
            <ul className="mt-5 space-y-3 text-sm text-ivory/70">
              ...
              {/* <li className="flex gap-2">
                ...
                <a
                  ...
                  className="hover:text-ivory underline"
                >
                  {SITE.email}
                </a>
              </li> */}
              <li className="flex items-center gap-2">
                ...
                <a
                  href={`mailto:${SITE.email}`}
                  className="hover:text-ivory underline relative z-10"
                >
                  {SITE.email}
                </a>
              </li>
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-2 text-xs text-ivory/60">
          ...
          {localSeoPages.map((page) => (
            <span key={page.slug}>
              ...
              <span className="ml-2 text-ivory/20" aria-hidden="true">
                ·
              </span>
            </span>
          ))}

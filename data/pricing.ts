...
export const pricingTiers = [
  ...
  },
  {
    ...
    items: [
      {
        name: "Free 15-Min Acupuncture Consult (In-Person)",
        price: 0,
        unit: "15 min",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Therapeutic Cupping (Fire & Moving Techniques)",
        price: 130,
        unit: "60 min",
      },
  ...
  },
  {
    ...
    items: [
      {
        name: "Thai Oil Massage (Relaxation or Deep Pressure)",
        price: 100,
        unit: "60 min",
      },
      {
      ...
      {
        name: "Brazilian Lymphatic Drainage Full Body",
        price: 148,
        unit: "60 min",
      },
      {
      ...
      {
        name: "Brazilian Lymphatic Drainage – Full Legs",
        price: 80,
        unit: "30 min",
      },
    ],
    ...
    items: [
      {
        ...
        unit: "3 x 60 min",
        description:
          "Includes 1 complimentary 30-min relaxation massage. Most popular!",
      },
      {
        ...
        unit: "4 x 60 min",
        description:
          "Includes 1 complimentary 45-min relaxation massage. Best value!",
      },
      {
        ...
        unit: "5 x 60 min",
        description:
          "Includes 1 complimentary 60-min relaxation massage. Full experience!",
      },
    ],
  },
];

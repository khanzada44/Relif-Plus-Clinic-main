...
},
{
  ...
  // Acupuncture
  {
    ...
    answer: "Acupuncture is a Traditional Chinese Medicine technique that uses fine, sterile needles placed at specific points on the body to help relieve pain, ease tension, and support the body's natural healing process.",
  },
  {
    category: "Acupuncture",
    question: "Does Acupuncture hurt?",
    answer: "Most patients feel little to no discomfort. The needles used are extremely fine, and many people find their acupuncture sessions relaxing rather than painful.",
  },
  {
    category: "Acupuncture",
    question: "Are Acupuncture needles sterile?",
    answer: "Yes. We use single-use, sterile needles for every patient, which are safely disposed of immediately after each session.",
  },
  {
    category: "Acupuncture",
    question: "Do you offer Cosmetic Acupuncture?",
    answer: "Yes. Cosmetic Acupuncture uses fine needling techniques on the face and body to support circulation and skin vitality, offered as part of a holistic treatment plan.",
  },
